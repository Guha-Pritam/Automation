...
from Projects.CN157 import CN157_const as CN
...
class CN157:
    ...
    def manual_testing(self):
        ...
        time.sleep(3)
        CF.take_image(pdf, CN.iframe,
                      'D:\\Automation\\Projects\\screenshot\\manual_0%.png',
                      'manual_0%.png')
        time.sleep(5)
        ...
        time.sleep(3)
        CF.take_image(pdf, CN.iframe,
                      'D:\\Automation\\Projects\\screenshot\\manual_56%.png',
                      'manual_56%.png')
        time.sleep(5)
        ...
        time.sleep(3)
        CF.take_image(pdf, CN.iframe,
                      'D:\\Automation\\Projects\\screenshot\\manual_95%.png',
                      'manual_95%.png')
        time.sleep(5)
        CF.old_update_progress_log(pdf)
        time.sleep(3)
